...
class HptCircularLoader extends StatelessWidget {
  ...
  const HptCircularLoader({
    super.key,
    this.foregroundColor = HptColors.white,
    this.backgroundColor = HptColors.primary,
  });
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.all(HptSizes.lg),
